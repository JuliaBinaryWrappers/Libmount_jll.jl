...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Libmount_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("4b2f31a3-9ecc-558c-b454-b3730dcb73e9"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Libmount", artifacts_toml) for e in artifacts["Libmount"]]
...
if best_platform === nothing
    @debug("Unable to load Libmount; unsupported platform $(triplet(platform_key_abi()))")
else
